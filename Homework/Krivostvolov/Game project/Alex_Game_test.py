...
if start == 1:
    ...
    choise_1 = 0
    if challenge_3 == 1 and pl_lvl < 2:# ничего нового  -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        print('У Вас слишком маленький уровень, что-бы им помочь')
        ...
        if challenge_4 == 1:
            ...
            print(f"\nВаша характеристика:\nHp:{pl_hp} Dammage:{pl_dmg} Lvl.{pl_lvl}")
    print('Game over')
    advice = int(input('Хотите ли Вы получить подсказку ?\n1 Да\n2 Нет\nВвод:'))
    if advice == 1:
        print('\n1)Попытайтесь заработать как можно высший уровень сваоего персонажа\n2) Напарники очень важны для прохождения, особенно Щитоносец в конце(у него большлй запас здоровья)\n3) Не будь бакай')
    else:
        print('Тогда пробуй всё заново')
        if challenge_4 == 2:
        ...
        if nora == 2:
            ...
            print('\nКогда вы уже почти прошли эту местность, то на выходе на Вас напали стая волков. Всего их было пятеро, что ставило Вас в трудное пололожение. Но из любой передряги есть выход. Только не в этот раз, стая волков просто загрызла Вас.')
        ...
        if choise_2 == 1: # С напарником
            ...
            print(f"Здоровье дракона: {y_result}")
            print('Ход дракона!')
            print('\n' + str(team_hp) + ' - ' + str(boss_dmg))
            print(f"Здоровье Вашей команды: {b_result}")
            print('\nВаш ход!')
